...
import img3 from './img/cover.jpg';
...
import img9 from './img/cover.jpg';
import img10 from './img/mirror.jpg';
import img11 from './img/cover.jpg';
import img12 from './img/cover.jpg';
...
function Exterior(){
    ...
    <div class="card"><img src={img3} alt="Img3"/>
        <div class="info">
        <h1>Car Exterior Accessories</h1>
        <p>we are in Partnership with carhatke. You can buy quality car accessories @ lowest price.</p>
